...
export default function FindAPlaceToGoChat() {
  const [messages, setMessages] = useState([{
    type: 'assistant',
    content: "Hi! I am the App assistant. What kind of thing are you feeling like visiting today?"
  }])
    ...
    recognition.onresult = async (event) => {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(async (position) => {
          ...
          // Here you would call your API to get recommendations
          // For now, we'll just add a mock response
          setMessages(prev => [...prev, {
            type: 'assistant',
            content: `I'll look for places near ${latitude}, ${longitude} based on your request: "${transcription}"`
          }])
        })
      }
    }
    ...
    <main className="min-h-screen p-4">
      <div className="max-w-2xl mx-auto pt-8">
        <div className="bg-white/80 rounded-xl p-6 min-h-[60vh]">
          ...
          <h1 className="text-2xl font-bold mb-6">Find a Place to Go!</h1>
        ...
        <div className="fixed bottom-4 left-0 w-full px-4">
          <div className="flex justify-between items-center max-w-2xl mx-auto">
            <Link href="/findaplacetogo" className="flex items-center space-x-2">
              <Image
                src="/leftarrow.png"
